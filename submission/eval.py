...
def load_trained_model(model_path: str, num_classes: int, device: str, image_size: int = 224):
    ...
    #         self.base = models.convnext_base(weights=models.ConvNeXt_Base_Weights.IMAGENET1K_V1)
    #         for param in self.base.parameters():
    #             param.requires_grad = False
    #         self.base.classifier[2] = nn.Linear(self.base.classifier[2].in_features, 256)
    ...
    # model = ConvNext() # Replace with your model creation function
    ...
    # model = joblib.load('SBDenseNetClassifier.pt') # Replace with your model creation function
    # model.loss_func = nn.CrossEntropyLoss()
    # model.optimizer = torch.optim.Adam(denseNet2.parameters(), lr=0.001)
    ...
    model = ResNetConvNet128() # Replace with your model creation function
